...
function h() {
    ...
    function e(a, b, c) {
        ...
        for (var f = 0; f < b.length; f += 2) {
            ...
            if (f % 6 === 4) {
                e += "\n" + new Array(a.length + 4).join(" ");
            } else if (f < b.length - 2) {
                e += " ";
            }
        }
    }
